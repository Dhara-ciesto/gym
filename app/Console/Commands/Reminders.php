...
//                               $otpsend = 0;
                             $whatsappmsg =  NotificationController::instance()->sendwhatsapp(array($mobileno),$package_expiry2);
                     ...
                     if ($interval == -2 || $interval == -1 || $interval == 0 || $interval == 1 || $interval == 2 || $interval == 3 || $interval == 7) {
                        ...
                        if ($u->sms == 1) {
                         ...
                         if ($smssetting) {
                              ...
                              $otpsend = Curl::to($url)->get();
//                              $otpsend = 0;
                             $whatsappmsg =  NotificationController::instance()->sendwhatsapp(array($mobileno),$duedate_msg_2);
            ...
            if ($member_birthday) {
                ...
                foreach ($member_birthday  as  $mb) {
                    ...
                    if ($mb->sms == 1) {
                        ...
                        $otpsend = Curl::to($url)->get();
//                        $otpsend = 0;
                            $whatsappmsg =  NotificationController::instance()->sendwhatsapp(array($mobileno),$bithday_msg_new2);
            ...
            if ($member_anniversary) {
                ...
                foreach ($member_anniversary  as  $ma) {
                    ...
                    if ($ma->sms == 1) {
                        ...
                        $otpsend = Curl::to($url)->get();
//                        $otpsend = 0;
                            $whatsappmsg =  NotificationController::instance()->sendwhatsapp(array($mobileno),$anniversary_msg_new2);
