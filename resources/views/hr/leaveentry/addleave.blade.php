                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <form action="{{ route('addleave') }}" method="post" id="workingdays" onsubmit="return validateForm()">
                                            {{ csrf_field() }}
                                            ...
                                            <div class="form-group">
                                                <label>Employee<span style="color: red;">*</span></label>
                                                <input type="hidden" name="employeeid" class="form-control" value="{{session()->get('employeeid')}}" readonly>
                                             <input type="text" name="employeename" class="form-control" value="{{session()->get('username')}}" readonly>
                                            </div>
                                            @endif
                                            ...
                                            <button type="submit" class="btn btn-primary bg-green" id="submit" onlick="check()">Save</button>
...
function validateForm() {
    ...
    console.log(StartDate!= '' && StartDate!= '' && sDate >= eDate);
    if(StartDate!= '' && StartDate!= '' && !(sDate <= eDate))
        {
        alert("Leave From Date and To Date is not valid");
        return false;
        }else{
            return true;
            // $('#workingdays').trigger('submit');
