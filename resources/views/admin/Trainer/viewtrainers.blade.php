...
<h3 class="box-title">Trainer Profile</h3>
                            <div class="" style="float: right;"><a href="{{ route('addtrainerprofile') }}" class="btn btn-primary bg-orange" title="Add Working days">Add Trainer Profile</a></div>              <div class="box-tools pull-right">
                ...
                <table class="table no-margin">
                  ...
                  @else
                    <tbody>
                      @foreach($data as $data1)  
                       <tr>
 <td><a  href="{{url('viewtrainerprofile/'.$data1->trainerprofileid)}}" class="edit" title="View"><i class="fa fa-eye"></i></a> </td>
