...
<div class="content-wrapper">
    ...
    <section class="content-header">
     	 <h1 style="text-decoration: none;">AnyTime Access Report</h1>
     </section>
                ...
                @foreach($beltnos as $beltno)
                  <option value="{{$beltno->beltno}}"  @if(isset($query['beltno'])) {{$query['beltno'] == $beltno->beltno ? 'selected':''}} @endif>{{ $beltno->beltno }}   </option>
                    @endforeach
								...
								<td style="text-align: left" colspan="3"><button type="submit" name="search" class="btn bg-green"><i class="fa fa-filter"></i>   Filters</button><a href="{{ url('anytimeaccesscardreport') }}" class="btn bg-red">Clear</a></td>
