...
@endif
  ...
  @endforeach
          ...
          <div class="col-md-3">
                  <div class="l"><button type="button"class="btn btn bg-green" style="margin-top: 25px;" name="plan" id="plan" value="plan">View</button></div>
                </div>
...
// alert(countheader1);
  ...
  ap+='<tr id="tab1firsttr'+counttab1+'" class="tab1item">';
            ...
            // $("#headeryes").val(0);
            ap+='<td><div class="form-group"><select class="form-control exercisename" name="tab1exercisename[]"><option value="" disabled="" selected="">Please select<option><?php foreach($exercise as $exercisetab1)
    {
          ...
          ap+='<td><div class="form-group"><select class="form-control select2"  data-selected-text-format="count"  data-actions-box="true" data-count-selected-text="{0} Exercise Selected" data-header="Select Exercise" data-live-search="true"  name="tab2exercisename[]"><option value="" disabled="" selected="">Please select</option><?php foreach($exercise as $exercisetab2)
              {
                  ...
                  ?>
                  </select></div></td><td><div class="form-group"><input type="text" id="tab2time'+counttab2+'" name="tab2time[]" class="form-control"></div></td><td><div class="form-group"><input type="text" name="tab2set[]" class="form-control number"></div></td><td><div class="form-group"><input id="tab2rep'+counttab2+'"type="text" name="tab2rep[]" class="form-control number exerciseset"></div></td> <td><div class="form-group"><input type="text" name="tab2instruction[]" class="form-control"></div></td>' +
          ...
          ap+='<td><div class="form-group"><select class="form-control select2" data-selected-text-format="count"  data-actions-box="true" data-count-selected-text="{0} Exercise Selected" data-header="Select Exercise"  data-live-search="true"  name="tab3exercisename[]"><option value="" disabled="" selected="">Please select</option>         <?php foreach($exercise as $exercisetab3)
              {
                  ...
                  ?>
                  </select></div></td><td><div class="form-group"><input type="text" id="tab3time'+counttab3+'" name="tab3time[]" class="form-control"></div></td><td><div class="form-group"><input type="text" name="tab3set'+counttab3+'" class="form-control number"></div></td><td><div class="form-group"><input id="tab3rep'+counttab3+'" type="text" name="tab3rep[]" class="form-control number exerciseset"></div></td> <td><div class="form-group"><input type="text" name="tab3instruction[]" class="form-control"></div></td>' +
          ...
          ap+='<td><div class="form-group"><select class="form-control select2"  data-selected-text-format="count"  data-actions-box="true" data-count-selected-text="{0} Exercise Selected" data-header="Select Exercise" data-live-search="true"  name="tab4exercisename[]"><option value="" disabled="" selected="">Please select</option>         <?php foreach($exercise as $exercisetab4)
              {
                  ...
                  ?>
                  </select></div></td><td><div class="form-group"><input type="text" name="tab4time[]" id="tab4time'+counttab4+'" class="form-control"></div></td><td><div class="form-group"><input type="text" name="tab4set[]" class="form-control number"></div></td><td><div class="form-group"><input id="tab4rep'+counttab4+'"type="text" name="tab4rep[]" class="form-control  exerciseset"></div></td> <td><div class="form-group"><input type="text" name="tab4instruction[]" class="form-control"></div></td>' +
