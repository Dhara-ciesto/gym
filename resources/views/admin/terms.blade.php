  ...
  <div class="box">
    <div class="box-header">
      ...
      @if(isset($permission["'add_term'"]))
        <a href="{{ url('assignedterms') }}" class="btn add-new bg-orange"><i class="fa fa-book"></i>Scheme Terms</a>

      <a href="{{ url('addterms') }}" class="btn add-new bg-orange"><i class="fa fa-plus"></i>Add New</a>
      @endif
