                     ...
                     <div class="table-responsive">
                        <table class="table no-margin">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 <td style="text-align: left" colspan="4"><button type="submit" name="search" id="submitbutton"class="btn bg-green"><i class="fa fa-filter"></i>   Filters</button><a href="{{ url('memberreport') }}" class="btn bg-red">Clear</a></td>
                              </tr>
                           </tbody>
                        </table>
                     </div>
