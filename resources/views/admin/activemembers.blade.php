...
<script src="{{ asset('bower_components/datatables.net/js/jquery.js') }}"></script>
  ...
  <div class="content-wrapper">
         ...
         <section class="content-header"><h2>Active Members</h2></section>
...
@endif 
     <div class="row">
       ...
       <div class="box-body">           
      <form method="post" action="{{ url('activemembers') }}">
     {{ csrf_field() }}
...
<td class="td" style="width: 20%;">
      ...
      <td>
                                       <select name="gender" class="form-control select2 span8" data-placeholder="Select a Gender" >
                                          <option value="" selected="" disabled="">Select a Gender</option>
                                             <option value="Female" {{ $query1['gender'] == 'Female' ? 'selected' : ''}}>Female</option>
                                             <option value="Male" {{ $query1['gender'] == 'Male' ? 'selected' : ''}}>Male</option>
                                       </select>
                                    </td>
 ...
 <td colspan="20">
    <button name="submit" type="submit" class="btn bg-green">Search</button> <a href="{{ url('activemembers') }}" class="btn bg-red">Clear</a>
  </td>
</tr>
</div>
</table>
...
<!--               <h3 class="box-title">All Members</h3>
 -->
             ...
             <!--      <a href="{{ url('addMember') }}" title="Add New Member" class="btn add-new bg-orange"><i class="fa fa-plus"></i> New Member</a> -->
              </div>
            </div>
