        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <a href="{{ url('followup') }}"><span class="close"></span></a>
              ...
              <br/>
                  ...
                  <div class="row">
                  <div class="timeline-body">
                    <div class="col-md-2">Member in other GYM ? : </div>  <div class="col-md-8">{{$info->alreadymember}}</div>
                  </div>
                  </div>
                  <br/>
                  <div class="row">
                  <div class="timeline-body">
                    <div class="col-md-2">Here about us ? : </div>  <div class="col-md-8">{{$info->hearabout}}</div>
                  </div>
                  </div>
                  <br/>
                  @if($info->remarks)
                  <div class="row">
                  <div class="timeline-body">
                    <div class="col-md-2">Here about us ? : </div>  <div class="col-md-8">{{$info->remarks}}</div>
                  </div>
                  </div>
                  <br/>
                  @endif
               <div class="row">
                    <div class="timeline-body">
                      <div class="col-md-2">Reference By :  </div>  <div class="col-md-8">@if($info->referenceby != null && $info->referenceby != "null" ){{$info->referenceby}}@endif</div>     
                    </div>
                  </div>
                  <br>
              </div>
              ...
              <div class="tab-pane" id="Reminders">
                ...
                @if($Reminders->schedulenextcalldate != '1970-01-01' && $Reminders->schedulenextcalldate != NULL)             
                <ul class="timeline timeline-inverse">
                  <!-- timeline time label -->
                  <li class="time-label">
                        <span class="bg-blue">
                  ...
                  <li>
                    ...
                    <div class="timeline-item">
                      ...
                      <div class="timeline-body">
                        <label> Schedule Next Call Date : </label> <b>{{ date('j F,Y',strtotime($Reminders->schedulenextcalldate))}}</b><br/><br/>
              ...
              <div class="tab-pane" id="Free">
                ...
                @foreach ($freetiral as $item)
                    
                
                @if($item->freetrialpackage && $item->trainer && $item->freetrial)
                 <ul class="timeline timeline-inverse">
                  <!-- timeline time label -->
                  <li class="time-label">
                        <span class="bg-blue">
                  ...
                  <li>
                    ...
                    <div class="timeline-item">
                      ...
                      <div class="timeline-body">
                         <label> Trainer Name Is : </label> <b>{{$item->trainer}} </b><br/><br/>
                        <label> Free Trial On : </label> <b>@if($item->freetrial){{date('j F, Y', strtotime($item->freetrial))}}@endif</b><br/><br/>
                        <label> Free Trial Package : </label> <b>{{$item->freetrialpackage}}</b>
                      </div>
                    </div>
                  </li>
