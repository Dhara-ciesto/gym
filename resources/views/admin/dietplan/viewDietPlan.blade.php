...
@endif 
          ...
          <div class="box box-primary">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">View Diet Plan</h3>
            </div>
            <!-- /.box-header -->
             <div class="box-body"> 
              ...
              <div class="col-lg-12" style="text-align: left;">
                <div class="col-lg-3">
                  ...
                  <label>Diet</label>
                <select name="dietplanname" class="form-control span11 select2" id="dietplan">
                  <option value="" disabled="" selected="">Please Select Diet</option>
                ...
                <div class="col-lg-4">
                  ...
                  <select id="tags" class="form-control span11 select2" multiple="" data-placeholder="Select a Tags" style="width: 100%;" tabindex="-1" aria-hidden="true"  name="exerciselevel[]" required="">
  ...
  @endforeach
           ...
           <div class="col-lg-4">
                  ...
                  <label>Diet Notes </label>
                   <select  class="form-control span11 select2" multiple="" data-placeholder="Select a Notes" style="width: 100%;" tabindex="-1" aria-hidden="true"  name="dietnotes[]" required="" id="notes">
...
<!--***********************************tab2************************************************ -->
           <div class="col-lg-12 box"> <center>
            <br>
                <div class="form-group">
                  <input type="submit" name="submit" class="btn bg-green" value="Update">
                </div>
                </center>
              </form>
            </div>
