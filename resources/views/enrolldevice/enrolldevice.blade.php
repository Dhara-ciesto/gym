           ...
           <div class="row">
            <div class="col-md-12">
              <ol class="breadcrumb">
                ...
                <li><a href="{{ route('enrolldevice') }}">Enroll Employee</a></li>
                                <li class="active">Enroll Employee in Device</li>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Enroll Employee</h3>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form method="post" class="form-inline">
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-3">
                                                        <select  class="form-control select2 span8" title="Select Employee" data-live-search="true" data-selected-text-format="count"  data-actions-box="true"  placeholder="Please Select Employee" required="" name="employeeid" id="employeeid" data-search="true">
                                                           @if(!empty($employee))
...
<!--                                                         <span id="empid_error" class="ajaxerror">Please select Employee</span>
 -->                                                    </div>
                                                ...
                                                <div class="form-row" style="margin-top: 45px; margin-left: 15px;">
                                                    <a  id="submit" class="btn bg-green">Submit</a>
                                                </div>
                                            </form>
                                        </div>
                            ...
                            @if(!empty($device))
                                @foreach($device as $key => $device_data)
                                    @if($device_data->main == 1)
                                        ...
                                        <div class="form-group">
                                            <label>No Of Finger</label>
                                            <input type="number" name="fingercount" class="form-control" id="fingercount"  value="">
                                        </div>
                                        <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#fingertemplate_save').click(function(){
            ...
            let empid = $('#employeeid').val();
            let fingercount = $('#fingercount').val();
            if(!fingercount){
                alert("Please add Finger Count");
                return false;
            }
            ...
            $('#loader').show();
                ...
                $.ajax({
                    ...
                    data : {empid:empid,fingercount:fingercount, _token : '{{ csrf_token() }}'},
                    success : function(data){
                        $('#loader').hide();
